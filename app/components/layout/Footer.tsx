...
import { getFullVersion, getEnvironment } from '@/lib/version'
...
export function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-gray-50 border-t border-gray-200 px-4 py-2 flex-shrink-0 z-10">
